...
const Team = () => {
  return (
    <>
      <Helmet>
        <title>El Equipo - El Fotógrapher | Documental</title>
        <meta name="description" content="Conoce al equipo detrás de El Fotógrapher: Guadalupe Gonzalez (Periodista) y Mariano Moreno (Psicólogo). Reparto y equipo del documental." />
        <meta name="keywords" content="El Fotographer reparto y equipo, Mariano Lupe Carlota personajes, director documental El Fotographer, equipo producción valencia" />
